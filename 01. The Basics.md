...
**parentheses inside brackets [()]**, the you put _directive_ **ngModel** and assign it your TypeScript property.

With this setup, the binding triggers on the **input** event and **updates the value** of your property (template → logic). 

The **opposite direction** (template ← logic) of binding works as well, the value of the HTML element can be preset in your **.ts file**
