...
**Create new project:**
- To **create new project**, navigate to your workspace folder where you want to create your project with a 
command `cd <path>`,
...
- to create new component in a different folder, **define path** in the command:
```bash
...
- to create new directive in a different folder, **define path** in the command:
```bash
