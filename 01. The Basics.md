...
# # The Basics
## ## Basic CLI commands
**CLI** is Angular **c**ommand **l**ine **i**nterface that help you to create and manage your Angular projects. 

For CLI to work, you must install [Node.js](https://nodejs.org/en/) first to work with its package ecosystem **npm**.

**Install CLI:**
- After installing, run **Command line** as administrator and **install CLI**:
```bash
npm install - g @angular/cli@latest
```

**Create new project:
- To **create new project**, navigate to your workspace folder where you want to create your project with a command `cd <path>`,
