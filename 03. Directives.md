...
- **Configure** your directive by defining the object in your decorator:
  ...
  CamelCaseNotation,
  - to make it a attribute director, put the string with the name of the director in 
  **brackets** `[ ]` (without them - the directive is an element, with a **dot** `.` it would be a class),
