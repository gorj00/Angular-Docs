...
- define the class of the **CanDeactivateGuard** guard
  - implement **CanDeactivate** interface from the imported Anggular router, it is a generic type, it takes your created interface _CanComponentDeactivate_ `implements CanDeactivate<CanComponentDeactivate>` (ensures easy connecting of the interface with the component):
