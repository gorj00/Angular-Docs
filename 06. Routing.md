...
- In a **parent component .html file** _(app.component.html in this case)_, **add** a **Router Outlet** directive as a selector HTML tag in a place, where you would normally put the component selector tag.
```typescript
