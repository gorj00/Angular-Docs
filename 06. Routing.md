...
- It is possible to create routes with **dynamic segments** in your path if the route

**1. step**
- In **app.module.ts**, in your reoutes paths definitions, write a **colon** and the name of the **dynamic segment** of the path `/:name-of-the-dynamic-segment` of the dynamic route,
- **example**:
```typescript
const appRoutes: Routes = [
    { path: 'users/:id', component: UserComponent }
    // domain.com/users/A-N-Y-T-H-I-N-G     will result in loading the UserComponent
];
```
