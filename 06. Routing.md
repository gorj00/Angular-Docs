...
- _routerLinkActive_ can be added as an attribute with the value of the CSS 
class higlighting the active link,
- the attribute can be placed as:  
  - an attribute of a **wrapping element**: `<li routerLinkActive="active"><a 
  routerLink="route">Page</a></li>`,
  - an attribute of the **link itself**: `<li><a 
  routerLink="route" routerLinkActive="active">Page</a></li>`
