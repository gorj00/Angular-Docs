...
```
- **navigate** method of a router takes an argument of an **array** (items of the array are parts of the router path), the example above will result in `domain.com/users/user/Jack`.
